...
//加载一次
  ...
  withShareTicket: true
		...
		console.log('onLoad')
		var that = this
		common.getTopProductListByType(that, app.globalData.appId, app.globalData.toobarIds[1]);

		common.getTypeList(that, app.globalData.appId, app.globalData.toobarIds[1], 1, 4,2)
  ...
  onShow:function(){
  	console.log('onShow')
  	var that = this
common.getHotProductListByType(that, app.globalData.appId, app.globalData.toobarIds[1], currentpage, pagesize);
	...
	tapBanner: function(e) {
		if(e.currentTarget.dataset.id != 0) {
			...
			wx.navigateTo({
				url: "/pages/goods-detail/index?goodid="+e.currentTarget.dataset.id
			})
		}
	},
	...
	onReachBottom: function () {
        ...
        complete:function(option){
        	...
        	common.getHotProductListByType(that, app.globalData.appId, app.globalData.toobarIds[1], currentpage+1, pagesize);
        					setTimeout(function() {
				wx.hideLoading();
			}, 1000);
